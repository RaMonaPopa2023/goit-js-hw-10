...
(0, _axiosDefault.default).defaults.headers.common["x-api-key"] = "live_HtHfoxYmdRfM59fQEj9nXgQe4i1mc2zQaqEKC2FTCwxz6fbn1q7lTT5wtxO8on6X";
document.addEventListener("DOMContentLoaded", ()=>{
    const breedSelect = document.querySelector(".breed-select");
    const loader = document.querySelector(".loader");
    const catInfo = document.querySelector(".cat-info");
    const errorElement = document.querySelector(".error");
    const slim = new (0, _slimSelectDefault.default)({
        select: breedSelect,
    ...
    function handleRequestError(error) {
        (0, _notiflixDefault.default).Notify.Failure(message);
    }
    ...
    showSelectLoader();
    (0, _catApi.fetchBreeds)().then((breeds)=>{
    ...
    breedSelect.addEventListener("change", ()=>{
        ...
        if (selectedBreedId) {
            ...
            (0, _catApi.fetchCatByBreed)(selectedBreedId).then((cat)=>{
                ...
                // Hide the loader
                hideCatInfoLoader();
                showError("Oops! Something went wrong. Try selecting a different breed.");
            });
        }
    });
});

},{"axios":"jo6P5","./cat-api":"d7YdZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","notiflix":"5z0Oc","slim-select":"lzHUr"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
function fetchBreeds() {
    return (0, _axiosDefault.default).get("https://api.thecatapi.com/v1/breeds").then((response)=>{
...
function fetchCatByBreed(breedId) {
    ...
    return (0, _axiosDefault.default).get(url).then((response)=>{
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5z0Oc":[function(require,module,exports) {
var global = arguments[3];
